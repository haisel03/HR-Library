/**
 * @module Lang
 * @description Archivo de traducción de la plantilla
 */
const $MONTHS = [
	"enero",
	"febrero",
...
const $DAYS_SHORTS =  ["Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"];
const $DAYS_MIN = ["do", "lu", "ma", "mi", "ju", "vi", "sa"];

const Lang = {

	// traducciones de meses y dias al español
	months: $MONTHS,
	short_months: $MONTHS_SHORTS,
	days: $DAYS,
	short_days: $DAYS_SHORTS,
	min_days: $DAYS_MIN,
