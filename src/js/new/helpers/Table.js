...
const Table = {
  ...
  col(data, title, options = {}) {
    const {
      ...
      width, icon, iconClass = "text-muted", truncate = null, tooltip = false, autoIcon = false,
    } = options;
  ...
  actions(optionsOrActions = {}) {
    ...
    return Table.col(null, title, {
      ...
      render: (data, type, row) => {
        ...
        return `<div class="table-actions d-flex gap-2 justify-content-center align-items-center">
          ${list.map((key) => {
