...
const Strings = {
	...
	contains: (text, search) => {
		...
		return Strings.normalize(text.toLowerCase()).includes(Strings.normalize(search.toLowerCase()));
	},
	...
	replaceAll: (str, search, replace) => (typeof str !== "string" ? "" : str.replaceAll(search, replace)),
