...
const _requestFS = (el) => el.requestFullscreen?.() ?? el.webkitRequestFullscreen?.() ?? el.msRequestFullscreen?.();

const _exitFS = () => document.exitFullscreen?.() ?? document.webkitExitFullscreen?.() ?? document.msExitFullscreen?.();
