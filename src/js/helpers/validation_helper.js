 ...
 * No manipula DOM ni formatea valores.
 */
const validation = {
  /**
   ...
   * @returns {boolean}
   *
   * @example validation.isNullOrEmpty(null) // true
   * @example validation.isNullOrEmpty("") // true
   */
  isNullOrEmpty: (value) =>
    value === null ||
    value === undefined ||
   ...
   * @param {string} email
   * @param {RegExp} [regex=config.validation.emailRegex]
   * @returns {boolean}
   */
   ...
   * @param {string} phone
   * @param {RegExp} [regex=config.validation.phoneRegex]
   * @returns {boolean}
   */
